...
Author: ibrahim.design
Design and Developed by: http://ibrahim.design/
...
jQuery(document).ready(function () {
  if (typeof $.fn.slick !== typeof undefined) {
    ...
    jQuery('#newrealease-slider .slick-active.slick-center')
      .next('.slick-active')
      .addClass('temp-next')
    ...
    jQuery('#newrealease-slider').on('afterChange', function () {
      ...
      jQuery(
        '#newrealease-slider .slick-active[data-slick-index="' + (slick_index - 1) + '"]'
      ).addClass('temp')
      jQuery(
        '#newrealease-slider .slick-active[data-slick-index="' + (slick_index - 2) + '"]'
      ).addClass('temp-1')
      jQuery(
        '#newrealease-slider .slick-active[data-slick-index="' + (slick_index - 3) + '"]'
      ).addClass('temp-2')

      jQuery(
        '#newrealease-slider .slick-active[data-slick-index="' + parseInt(slick_index + 1) + '"]'
      ).addClass('temp-next')
      jQuery(
        '#newrealease-slider .slick-active[data-slick-index="' + parseInt(slick_index + 2) + '"]'
      ).addClass('temp-next-1')
      jQuery(
        '#newrealease-slider .slick-active[data-slick-index="' + parseInt(slick_index + 3) + '"]'
  ...
  if ($sliders.length > 0) {
    $sliders.each(function () {
      ...
      var sw_config = {
        ...
        pagination: slider.data('pagination') ? ibrahimPagination : '',
        breakpoints: breakpoint
      }
      var swiper = new Swiper(slider[0], sw_config)
    })
