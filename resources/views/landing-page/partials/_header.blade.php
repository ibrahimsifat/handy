                    ...
                    <ul class="top-header-left list-inline d-flex align-items-center gap-3 m-0">
                        <li>
                            @php
                                ...
                                $generalsetting = App\Models\Setting::where('type', 'general-setting')
                            ...
                            <a class="text-white d-flex align-items-center"
                                href="tel:{{ optional($appsetting)->helpline_number }}">
                    ...
                    <div class="d-inline-block">
                        @if ($sectionData && isset($sectionData['header_setting']) && $sectionData['header_setting'] == 1)
                            @if ($sectionData['enable_language'] == 1)
                                <a class="dropdown text-white d-flex align-items-center" data-bs-toggle="dropdown"
                        ...
                        <a class="dropdown-item d-block" href="https://apps.ibrahim.design/frezka/app/language/fr">
                           French
                        </a> -->
                                    <?php
                ...
                <div class="d-flex gap-3 gap-xl-0 align-items-center">
                    <div>
                        <button data-trigger="navbar_main" id="res_sidebar"
                            class="d-xl-none btn btn-primary rounded-pill p-1 pt-0 toggle-rounded-btn lh-base"
                            type="button">
                        ...
                        <ul class="navbar-nav align-items-center ms-auto mb-2 mb-xl-0 p-0">
                                ...
                                @if ($sectionData['enable_darknight_mode'] == 1)
                                    <li class="nav-item theme-scheme-dropdown dropdown iq-dropdown">
                                        <a href="javascript:void(0)"
                                            ...
                                            <svg class="mode-icons light-mode" width="18" height="18"
                                            ...
                                            <svg class="mode-icons dark-mode" width="18" height="18"
                                                fill="currentColor" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 1024.0412 1024">
                                                <path
                                            ...
                                            <div class="btn-inner">
                                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                                    ...
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        ...
                                                        stroke-linejoin="round" />
                                                    <path
                                                        d="M12.3334 4.58325C13.225 4.87159 13.855 5.66742 13.9309 6.60158"
                            ...
                            @if (empty(auth()->user()) || auth()->user()->user_type !== 'user')
                                <li class="ms-sm-3 ms-2">
                                    <a href="{{ route('user.login') }}" class="btn btn btn-outline-primary"
                                        role="button">
                                            ...
                                            <div class="icon-50">
                                                <span class="btn-inner d-inline-block position-relative">
                                                    <img src="{{ getSingleMedia(auth()->user(), 'profile_image') }}"
                                                        class="img-fluid avatar-50 rounded-circle object-cover"
                                                        alt="icon">
                                                </span>
                                            </div>
                                        </a>
                                        <ul class="dropdown-menu dropdown-menu-end user-dropdown-menu p-0"
                                            ...
                                            <li>
                                                <span class="dropdown-item">
                                                    <svg width="15" height="15" viewBox="0 0 24 24"
                                                        ...
                                                        <path d="M18 16L16 16M16 16L14 16M16 16L16 14M16 16L16 18"
                                                            stroke="currentColor" stroke-width="1.5"
                                                    ...
                                                    <span class="ms-2">
                                                        ...
                                                        <span
                                                            class="text-primary">{{ getPriceFormat($wallet_amount) }}</span>
                                                    </span>
                                                </span>
                                            </li>
                                          ...
                                          this.closest('form').submit();">
                                                        <svg width="15" height="15" viewBox="0 0 15 15"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <g id="Logout">
                                                                <path id="Fill 1" fill-rule="evenodd"
                                                                    clip-rule="evenodd"
                                                                    ...
                                                                    fill="currentColor" />
                                                                <g id="Group 5">
                                                                    <mask id="mask0_880_191"
                                                                        style="mask-type:luminance"
                                                                        maskUnits="userSpaceOnUse" x="4" y="7"
                                                                        width="11" height="1">
                                                                        <path id="Clip 4" fill-rule="evenodd"
                                                                            clip-rule="evenodd"
                                                                            d="M4.99731 7H14.0246V8H4.99731V7Z"
                                                                            fill="white" />
                                                                    </mask>
                                                                    <g mask="url(#mask0_880_191)">
                                                                        <path id="Fill 3" fill-rule="evenodd"
                                                                            clip-rule="evenodd"
                                                                ...
                                                                <g id="Group 8">
                                                                    <mask id="mask1_880_191"
                                                                        style="mask-type:luminance"
                                                                        maskUnits="userSpaceOnUse" x="11" y="5"
                                                                        width="4" height="5">
                                                                        <path id="Clip 7" fill-rule="evenodd"
                                                                            clip-rule="evenodd"
                                                                            d="M11.073 5.05664H14.0246V9.94381H11.073V5.05664Z"
                                                                            fill="white" />
                                                                    </mask>
                                                                    <g mask="url(#mask1_880_191)">
                                                                        <path id="Fill 6" fill-rule="evenodd"
                                                                            clip-rule="evenodd"
