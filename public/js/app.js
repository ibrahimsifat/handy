...
Design and Developed by: ibrahim.design
...
;(function (jQuery) {
  ...
  const resetActionButtons = () => {
    checkRow()
    if (
      document.getElementById('select-all-table') !== undefined &&
      document.getElementById('select-all-table') !== null
    ) {
